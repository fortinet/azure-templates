...
| Use cases/ Architectures              | [Single FGT](https://github.com/fortinet/azure-templates/tree/main/FortiGate/A-Single-VM) | [Active Passive SDN ](https://github.com/fortinet/azure-templates/tree/main/FortiGate/Active-Passive-SDN)| [Active Passive ELB/ILB](https://github.com/fortinet/azure-templates/tree/main/FortiGate/Active-Passive-ELB-ILB) | [Active Active ELB/ILB](https://github.com/fortinet/azure-templates/tree/main/FortiGate/Active-Active-ELB-ILB) | [Virtual WAN](https://github.com/fortinet/azure-templates/tree/main/FortiGate/AzureVirtualWAN) | [Active Passive Azure Route Server](https://github.com/fortinet/azure-templates/tree/main/FortiGate/AzureRouteServer) | [Auto-Scale Cluster](https://github.com/fortinet/azure-templates/tree/main/FortiGate/Autoscale) | [Gateway Load Balancer](https://github.com/fortinetsolutions/Azure-Templates/tree/master/GWLB) |
|---------------------------------------|------------|--------------------|------------------------|-----------------------|-------------|-----------------------------------|--------------------|-----------------------|
